package io.github.susimsek.springaisamples.controller.stuff;
...
public class OlympicController {
    ...
    public ResponseEntity<String> get2024OlympicSports(
        ...
        @Size(min = 2, max = 100, message = "{validation.field.size}")
        String message,
        ...
        @NotNull(message = "{validation.field.notNull}") boolean stuffit
    ) {
